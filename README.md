...
Google Mapsを使って、豆を購入できるお店を検索できます。
...
- 豆投稿機能
  ...
  - 豆の画像をアップロードできる
  - 入力できる情報は、銘柄（品名）、産地、農園、購入店の情報、焙煎度（浅・中・深煎りのいずれかをプルダウンで選択）、味チャート（苦味・甘味・酸味・コク・香りのそれぞれをレーティング形式で入力）、コメント
- 豆編集機能
- 豆削除機能
- 豆詳細にコメントを投稿できる機能
- コメント編集機能
...
- Google Mapsを使ったお店の場所検索機能
  ...
  - 店舗名や地名で検索できる
- お店の詳細情報の確認機能
  - 地図上に表示されているピンをクリックすると、お店の詳細情報を確認できる機能
...
- ユーザー関連
  ...
  - マイページにて、ブックマーク・いいねした投稿とお店を確認できる機能
- レスポンシブ対応
- 検索フォームのオートコンプリート機能
- プライバシーポリシー
- 利用規約
